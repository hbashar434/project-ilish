  ...
  return (
    <div className="relative group flex items-center px-6 md:px-0">
      <input
        ...
        className="my-bg-tertiary rounded-full py-2 px-4 focus:outline-none ring ring-emerald-600 dark:ring-emerald-900 focus:border-indigo-500 transition duration-300 w-72 md:w-96 lg:w-[40rem]"
      />
