            ...
            <section className="w-10/12 relative mx-auto rounded-md shadow-lg">
                ...
                <div className="bg-slate-900/50 rounded-md absolute inset-0 text-white flex flex-col items-center justify-center">
                    ...
                    <div className='sidebar-paragraph-text space-y-2 md:space-y-4'>
                        <p className='flex justify-center items-center'><MdCall size={24} /><span className='ml-2'>+8801988545311</span></p>
                        <p className='flex justify-center items-center'><MdCall size={24} /><span className='ml-2'>+8801613506705</span></p>
                        <p className='flex justify-center items-center'><MdCall size={24} /><span className='ml-2'>+8801858985731</span></p>
                        <p className='flex justify-center items-center'><MdCall size={24} /><span className='ml-2'>+8801517073117</span></p>
                    </div>
