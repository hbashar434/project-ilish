...
const ShopNow = () => {
  return (
	...
	<div className="container grid grid-cols-2 gap-4 p-4 mx-auto md:grid-cols-4      flex justify-center items-center h-screen    ">
        ...
        <p className="text-xl font-semibold mb-4 text-center">Your New Text Here</p>
